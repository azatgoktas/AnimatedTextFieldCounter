...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AnimatedTextFieldCounter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/azattgoktas@gmail.com/AnimatedTextFieldCounter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'azattgoktas@gmail.com' => 'azattgoktas@gmail.com' }
  s.source           = { :git => 'https://github.com/azattgoktas@gmail.com/AnimatedTextFieldCounter.git', :tag => s.version.to_s }
